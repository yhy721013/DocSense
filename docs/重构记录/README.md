...
| `260728-知识谱系类别文件对话详细实施计划.md` | L3 已完成专项计划：阶段 0～7 已完成选择器、不可变会话绑定、直接文件首轮快照、Schema v5、原子受理、run_id 恢复、历史字段互斥和离线关闭验收。 |
| `260728-知识谱系类别文件对话详细集成计划.md` | L3 部分执行集成计划：开发实现与离线 I0～I4、I6 已完成；最新 main 漂移、真实发布/前后端演练和主线合入复验仍待执行。 |
