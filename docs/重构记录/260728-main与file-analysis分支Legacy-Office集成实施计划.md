...
| M1 Git 图合并 | 待执行 | M0 收口提交完成后，从最新 `main` 建立独立集成工作树 |
| M2—M10 | 待执行 | 严格逐阶段通过门禁后推进 |

M0 的详细证据见 `docs/更新记录/260728-main与file-analysis分支Legacy-Office集成M0执行记录.md`。
