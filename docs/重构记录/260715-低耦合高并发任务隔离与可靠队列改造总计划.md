...
| 编写日期 | 2026-07-15 |
| 适用基线 | `main@0023c47` |
| 文档状态 | 实施中；阶段 0 已有条件关闭，阶段 1 的 1A、1B 和 1C 已完成并通过离线关闭验收，下一步为 1D L3 文件级设计与 1D-0；报告类型 check-task 已在 1C 使用共享 Callback Guard 保留甲方要求的同步恢复副作用，阶段 3～6 增加可靠队列后台兜底但不替换同步入口；真实性能基线按批准延期 |
