...
| 1H | 共享文档处理与 Translator 解耦 | 独立 `document_processing` 模块、MHTML/MinerU/OCR/Office Adapter、不可变 Artifact/Profile/Lineage、任务级资源和 Translator 兼容 Facade；阶段 3 再切 MinIO |
| 1G | Debug、组合根和遗留清理 | Debug Adapter、框架无关 Bootstrap、薄蓝图和旧路径清理证据；最终删除等待 1H-7 三类引用清零 |
