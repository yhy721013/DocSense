...
_CANDIDATE_SCHEMA_VERSION_WITH_ARCHITECTURE = 2
...
_LEGACY_DOCUMENT_FIELDS = _DOCUMENT_FIELDS - {"structured_source_key"}
...
class ChatDocumentCandidate:
    ...
    def to_input_tuple(self) -> tuple[str, str, str, str, str]:
    ...
    def from_payload(
        ...
        *,
        ...
        if payload_fields not in {_DOCUMENT_FIELDS, _LEGACY_DOCUMENT_FIELDS}:
        ...
        return cls(
            ...
            structured_source_key=payload.get("structured_source_key", ""),
        )
...
class ChatDocumentSelectionCandidates:
    ...
    def from_payload(
        ...
        if schema_version == _LEGACY_CANDIDATE_SCHEMA_VERSION:
            ...
            _CANDIDATE_SCHEMA_VERSION_WITH_ARCHITECTURE,
