...
from app.modules.chat.domain.models import ChatRunEvent
from app.modules.chat.adapters.sqlite.repositories import _Repository, _required_text, _utc_now_iso
