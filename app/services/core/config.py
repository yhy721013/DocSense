...
def load_rag_enhancer_config() -> RAGEnhancerConfig:
    return RAGEnhancerConfig(
        ...
        # v3.0 新增：BM25 索引缓存 TTL（秒），默认 1800（30 分钟）
        bm25_cache_ttl=_parse_int(os.getenv("RAG_BM25_CACHE_TTL"), 1800, min_value=60),
    )
