...
FIELD_DESCRIPTIONS = {
    ...
    "服役状态": "提取在役、建造中、退役或其他状态描述以及各种状态对应的舰艇数目。",
    "舰艇清单": "提取该舰级包含的舰名、舷号及状态清单。",
    "建造单位": "提取建造厂、承包商、系统集成商或相关建造单位。",
    "建造节点": "提取铺龙骨、下水、服役、交付、海试、合同等时间节点。如果资料中包含多个舰级或型号，请分别提取并列出不同型号及其对应信息。",
    "排水量": "提取标准、满载或其他排水量指标。如果资料中包含多个舰级或型号，请分别提取并列出不同型号及其对应信息。",
    "全长": "提取舰艇总长或 overall length。如果资料中包含多个舰级或型号，请分别提取并列出不同型号及其对应信息。",
    "全宽": "提取舰宽、型宽或 beam。如果资料中包含多个舰级或型号，请分别提取并列出不同型号及其对应信息。",
    "吃水": "提取吃水、draught/draft 等指标。如果资料中包含多个舰级或型号，请分别提取并列出不同型号及其对应信息。",
    "航空能力": "提取舰载机、直升机、无人机、机库、飞行甲板、航空燃油或航空人员能力。",
    "最高航速": "提取最高航速、top speed 或 speed。",
    "航程续航": "提取航程、续航力、航速条件或 range/endurance。",
    "人员容量": "提取舰员、军官、航空人员、登陆部队、搭载人员等容量。详细列出不同类型人员的容量时请注明人员类型。",
